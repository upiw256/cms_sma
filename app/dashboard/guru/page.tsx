        ...
        <Table>
          <TableHeader className="bg-slate-50 dark:bg-slate-800/50">
            <TableRow className="dark:border-white/5">
              <TableHead className="dark:text-slate-300">NIP</TableHead>
              ...
              teachers.map((teacher: any) => (
                <TableRow key={teacher._id.toString()} className="dark:border-white/5 hover:dark:bg-slate-800/30 transition-colors">
                  ...
                  <TableCell className="text-right space-x-2">
                    <Button variant="outline" size="sm" className="dark:border-white/10 dark:hover:bg-slate-800 dark:text-slate-300">Tugas</Button>
