  ...
  return (
    <div className="py-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-extrabold mb-8 text-center text-slate-900 border-b pb-6">Profil {config?.name}</h1>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm">
          ...
          <ul className="space-y-4">
            <li className="flex gap-4">
              <span className="font-semibold text-slate-800 w-32">NPSN:</span>
              <span className="text-slate-600">{config?.npsn || "-"}</span>
            </li>
            <li className="flex gap-4">
              <span className="font-semibold text-slate-800 w-32">Kepala Sekolah:</span>
              <span className="text-slate-600">{config?.headmaster_name || "-"}</span>
            </li>
            <li className="flex gap-4">
              <span className="font-semibold text-slate-800 w-32">Alamat:</span>
              <span className="text-slate-600">{config?.contact_info?.address || "-"}</span>
            </li>
            <li className="flex gap-4">
              <span className="font-semibold text-slate-800 w-32">Kategori:</span>
              <span className="text-slate-600">Sekolah Menengah Atas (Negeri)</span>
            </li>
          </ul>
        </div>
      </div>
